    ...
    <section className='c-space section-spacing'>
      ...
      <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
        ...
        <div className='flex items-end grid-default-color grid-1'>
            <img src="assets/coding-pov.png" className='absolute scale-[1.75 -right-[5rem] -top-[1rem] md:scale-[3] md:left-50 md:inset-y-10 lg:scale-[2.5]' alt="code-img" />
            <div className='z-10'>
                <p className='headtext'>👨‍🚀</p>
                <p className='subtext'>
                    Backed by two years of hands-on experience, I design and develop full-stack web apps that are responsive, dynamic, and user-focused.
                </p>
            </div>
            <div className='absolute inset-x-0 pionter-events-none-bottom-4 h-1/2 sm:h-1/3 bg-gradient-to-t from-indigo'/>
        </div>
        {/* Grid 2 */}
        ...
        <div className='grid-black-color grid-3'>
          <div className='z-10 w-[50%]'>
            ...
            <p className='subtext'>India-based, available for remote work worldwide or on-site roles wherever needed.</p>
          </div>
        ...
        <div className='grid-default-color grid-5'>
          <div className='z-10 w-[50%]'>
            ...
            <p className='subtext'>I specialize in modern languages, frameworks, and tools that empower me to craft scalable, high-performance applications</p>
          </div>
